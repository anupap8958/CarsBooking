...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <br>
            <p class="text-center">เริ่มต้นด้วยการสร้างบัญชีพนักงาน</p>
        </div>
    </div>
    ...
    <div class="container" style="margin-top: -1%; margin-bottom: 2%;">
        <div class="col-md-5 col-md-offset-4">
            <div class="panel panel-primary">
                <div class="panel-heading"> สร้างบัญชีพนักงาน </div>
                <div class="panel-body">
                    ...
                    <form role="form" action="client_registered_success.php" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="client_name"><span class="text-danger" style="margin-right: 5px;">*</span> ชื่อ - นามสกุล: </label>
                                <div class="input-group">
                                    <input class="form-control" id="client_name" type="text" name="client_name" placeholder="ชื่อและนามสกุล" required="" autofocus="">
                  ...
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-user" aria-hidden="true"></label>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    <input class="form-control" id="client_username" type="text" name="client_username" placeholder="ชื่อผู้ใช้งาน" required="">
                                    <span class="input-group-btn">
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-user" aria-hidden="true"></label>
              </span>
                                    </span>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="client_email"><span class="text-danger" style="margin-right: 5px;">*</span> อีเมลล์: </label>
                                <div class="input-group">
                                    <input class="form-control" id="client_email" type="email" name="client_email" placeholder="อีเมลล์" required="">
                                    <span class="input-group-btn">
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></label>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="client_phone"><span class="text-danger" style="margin-right: 5px;">*</span> เบอร์ติดต่อ: </label>
                                <div class="input-group">
                                    <input class="form-control" id="client_phone" type="text" name="client_phone" placeholder="เบอร์ติดต่อ" required="">
                                    <span class="input-group-btn">
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-contact" aria-hidden="true"></span></label>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="client_address"><span class="text-danger" style="margin-right: 5px;">*</span> ที่อยู่: </label>
                                <div class="input-group">
                                    <input class="form-control" id="client_address" type="text" name="client_address" placeholder="ที่อยู่" required="">
                                    <span class="input-group-btn">
                  ...
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                        ...
                        <label style="margin-left: 5px;"><a href="clientlogin.php">มีบัญชีแล้วใช่หรือไม่? เข้าสู่ระบบ</a></label>

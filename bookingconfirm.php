...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center" style="color: green;"><span class="glyphicon glyphicon-ok-circle"></span> จองสำเร็จ</h1>
        </div>
    </div>
    <br>
 

    <h3 class="text-center"> <strong>หมายเลขรายการ :</strong> <span style="color: blue;"><?php echo "$id"; ?></span> </h3>


    <div class="container">
        <h5 class="text-center">โปรดอ่านรายละเอียดด้านล่างเกี่ยวกับรายการจองของคุณ</h5>
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                ...
                if($charge_type == "days"){
                ?>
                     <h4> <strong>อัตราค่าบริการ :</strong> Rs. <?php echo $fare; ?>/day</h4>
                <?php } else {
                    ?>
                    <h4> <strong>อัตราค่าบริการ :</strong> Rs. <?php echo $fare; ?>/km</h4>

                <?php } ?>

                <br>
                <h4> <strong>จองวันที่ : </strong> <?php echo date("Y-m-d"); ?> </h4>
                <br>
                <h4> <strong>เริ่มต้น : </strong> <?php echo $rent_start_date; ?></h4>
                <br>
                <h4> <strong>คืนรถวันที่ : </strong> <?php echo $rent_end_date; ?></h4>
                <br>
                <h4> <strong>พนักงานขับรถ : </strong> <?php echo $driver_name; ?> </h4>
                <br>
                <h4> <strong>เพศพนักงานขับรถ : </strong> <?php echo $driver_gender; ?> </h4>
                <br>
                <h4> <strong>หมายเลขประจำตัวพนักงานขับรถ : </strong>  <?php echo $dl_number; ?> </h4>
                <br>
                <h4> <strong>เบอร์ติดต่อพนักงานขับรถ :</strong>  <?php echo $driver_phone; ?></h4>
                <br>
                <h4> <strong>พนักงานดูแล :</strong>  <?php echo $client_name; ?></h4>
                <br>
                <h4> <strong>เบอร์ติดต่อพนักงานดูแล : </strong> <?php echo $client_phone; ?></h4>
                <br>
            </div>
        </div>

...
<div class="container">
      <div class="jumbotron">
        <h1 class="text-center">ส่งคืนรถที่นี่</h1>
      </div>
    </div>
...
<tr>
<th width="30%">รถ</th>
<th width="20%">วันเริ่มต้นการเช่า</th>
<th width="20%">วันสิ้นสุดการเช่า</th>
<th width="20%">ระยะทาง</th>
...
?></td>
<td><a href="returncar.php?id=<?php echo $row["id"];?>"> ส่งคืนรถ </a></td>
</tr>
<?php        } ?>
                </table>
                </div> 
        <?php } else {
            ...
            <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">ไม่มีรถที่ต้องส่งคืน</h1>
      </div>
    </div>

...
<head>
    ...
    <title>Car Booking Silpakorn</title>
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <div id="sec2" style="color: #777;background-color:white;text-align:center;padding:50px 80px;text-align: justify;">
        <h3 style="text-align:center;">รถที่สามาถใช้งานได้ขณะนี้</h3>
<br>
        <section class="menu-content">
            ...
            <h6> ประกัน : <?php echo ("Rs. " . $ac_price . "/km & Rs." . $ac_price_per_day . "/day"); ?></h6>
            <h6> ไม่มีประกัน : <?php echo ("Rs. " . $non_ac_price . "/km & Rs." . $non_ac_price_per_day . "/day"); ?></h6>
            ...
            <?php }}
                ...
                ?>
<h1> ไม่มีรถที่สามารถใช้งานได้ในขณะนี้ :( </h1>
                <?php
            }
            ?>                                   
        </section>
